		...
		<div class="vlt-navbar vlt-navbar--main vlt-navbar--transparent vlt-navbar--sticky">
			...
			<div class="vlt-navbar-inner">
				<div class="vlt-navbar-inner--left">
					<!--Logo--><a class="vlt-navbar-logo" href="index.html"><img src="" alt="AKR"></a>
				</div>
					...
					<div class="container">
						<nav class="vlt-default-menu__navigation">
							...
							<ul class="sf-menu">
								...
								<li data-menuanchor="Testimonials"><a href="#Testimonials">Achivements</a>
								</li>
	...
	<div class="vlt-offcanvas-menu">
		...
		<div class="vlt-offcanvas-menu__footer">
			...
			<div class="vlt-offcanvas-menu__copyright">
				<p>© 2023 Copyright.<br>All rights reserved.</p>
			</div>
		</div>
	</div>
							...
							<div class="row">
								<div class="col-lg-5">
									...
									<div class="vlt-animated-block" data-animation-name="fadeInUpSm" style="animation-delay:.1s; animation-duration:700ms;">
										<span class="vlt-display-1 has-white-color">Team Lead Web Designer</span>
									</div>
									...
									<div class="vlt-animated-block" data-animation-name="fadeInUpSm" style="animation-delay:.2s; animation-duration:700ms;">
										<h1 class="vlt-large-heading">Ankush <br> Kumar<span class="has-accent-color">.</span></h1>
									</div>
									<div class="vlt-gap-15"></div>
									<!--Animated Block-->
									<div class="vlt-animated-block" data-animation-name="fadeInUpSm" style="animation-delay:.3s; animation-duration:700ms;">
										<p>Creative and experienced personal web designer with a passion for creating beautiful, user-friendly websites that reflect my clients' unique personalities and goals. Proven ability to understand client needs and translate them into effective designs, and to work with a variety of technologies and software to bring those designs to life.</p>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="row">
								...
								<div class="col-xl-6 col-md-8">
									...
									<div class="vlt-animated-block" data-animation-name="fadeInUpSm" style="animation-delay:.4s; animation-duration:700ms;">
										<!--Progress Bar-->
										<div class="vlt-progress-bar" data-final-value="96" data-animation-speed="1000">
											<h5 class="vlt-progress-bar__title">HTML5/CSS3<span class="counter">0</span>
											</h5>
											<div class="vlt-progress-bar__bar"><span></span></div>
										</div>
									</div>
									...
									<div class="vlt-animated-block" data-animation-name="fadeInUpSm" style="animation-delay:.5s; animation-duration:700ms;">
										...
										<div class="vlt-progress-bar" data-final-value="90" data-animation-speed="1000">
											<h5 class="vlt-progress-bar__title">SCSS/LESS<span class="counter">0</span>
											</h5>
											<div class="vlt-progress-bar__bar"><span></span></div>
										</div>
									</div>
									...
									<div class="vlt-animated-block" data-animation-name="fadeInUpSm" style="animation-delay:.5s; animation-duration:700ms;">
										...
										<div class="vlt-progress-bar" data-final-value="80" data-animation-speed="1000">
											<h5 class="vlt-progress-bar__title">Mockup<span class="counter">0</span>
											</h5>
											<div class="vlt-progress-bar__bar"><span></span></div>
										</div>
									</div>
									...
									<div class="vlt-animated-block" data-animation-name="fadeInUpSm" style="animation-delay:.5s; animation-duration:700ms;">
										<!--Progress Bar-->
										<div class="vlt-progress-bar" data-final-value="90" data-animation-speed="1000">
											<h5 class="vlt-progress-bar__title">Bootstrap3/4/5<span class="counter">0</span>
											</h5>
											<div class="vlt-progress-bar__bar"><span></span></div>
										</div>
									</div>
									...
									<div class="vlt-animated-block" data-animation-name="fadeInUpSm" style="animation-delay:.5s; animation-duration:700ms;">
										<!--Progress Bar-->
										<div class="vlt-progress-bar" data-final-value="80" data-animation-speed="1000">
											<h5 class="vlt-progress-bar__title">Bulma<span class="counter">0</span>
											</h5>
											<div class="vlt-progress-bar__bar"><span></span></div>
										</div>
									</div>
							...
							<div class="row">
								<div class="col-xl-4">
									...
									<div class="vlt-animated-block" data-animation-name="fadeInUpSm" style="animation-delay:0s; animation-duration:700ms;">
										<h3>Contact</h3>
										<div class="vlt-gap-30"></div>
										<p>ou can reach me at email or phone number as given below:</p>
										<div class="vlt-gap-40"></div>
										<address>Mohali, Punjab, India</address>
										<p><a class="tel" href="tel:+72126742510">+91 7508028696</a></p>
										<p><a class="email" href="mailto:gilber.design@gmail.com">ankush.rana3565@gmail.com</a></p>
									</div>
								</div>
